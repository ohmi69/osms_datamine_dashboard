export const ICONS = {
  ...
  skull:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12.5 17-.5-1-.5 1h1z"/><path d="M15 22a1 1 0 0 0 1-1v-1a2 2 0 0 0 1.56-3.25 8 8 0 1 0-11.12 0A2 2 0 0 0 8 20v1a1 1 0 0 0 1 1z"/><circle cx="15" cy="12" r="1"/><circle cx="9" cy="12" r="1"/></svg>',
  map:
  ...
  flaskConical:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2v6l3 10H7L10 8V2"/><path d="M6 2h12"/><path d="M6 13h12"/></svg>',
  newspaper:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 18h-5"/><path d="M18 14h-8"/><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2"/></svg>',
  sparkles:
...
export const TABS = [
  { id: 'overview',  label: 'Overview',   icon: ICONS.chartColumn },
  { id: 'monsters',  label: 'Monsters',   icon: ICONS.skull },
  { id: 'maps',      label: 'Maps',       icon: ICONS.map },
  { id: 'skills',    label: 'Skills',     icon: ICONS.swords },
  { id: 'crafting',  label: 'Crafting',   icon: ICONS.hammer },
  { id: 'items',     label: 'Items',      icon: ICONS.scrollText },
  { id: 'equipment', label: 'Equipment',  icon: ICONS.swords },
  { id: 'cashshop',  label: 'Cash Shop',  icon: ICONS.shoppingBag },
  { id: 'quests',    label: 'Quests',     icon: ICONS.bookOpen },
  { id: 'formulas',  label: 'Formulas',   icon: ICONS.flaskConical },
  // { id: 'beauty',    label: 'Beauty',     icon: ICONS.sparkles },
];
