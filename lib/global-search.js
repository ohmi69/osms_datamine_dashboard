...
export const GLOBAL_SEARCH_CATEGORIES = [
  { id: 'monsters', label: 'Monsters', tabId: 'monsters', fallback: 'MOB' },
  { id: 'maps', label: 'Maps', tabId: 'maps', fallback: 'MAP' },
  { id: 'skills', label: 'Skills', tabId: 'skills', fallback: 'SKL' },
  { id: 'items', label: 'Items', tabId: 'items', fallback: 'ITM' },
  { id: 'equipment', label: 'Equipment', tabId: 'equipment', fallback: 'EQP' },
  { id: 'crafting', label: 'Recipes', tabId: 'crafting', fallback: 'RCP' },
  { id: 'quests', label: 'Quests', tabId: 'quests', fallback: 'QST' },
  { id: 'cashshop', label: 'Cash Shop', tabId: 'cashshop', fallback: 'NX' },
  { id: 'beauty', label: 'Beauty', tabId: 'beauty', fallback: 'STY' },
];
...
export function renderGlobalSearch(index, options = {}) {
  ...
  heading.appendChild(el('span', { className: 'global-search__scope', textContent: 'Monsters · Maps · Items · Quests · more' }));
  ...
  function render() {
    ...
    for (const { category, records } of groups) {
      ...
      label.appendChild(el('span', { className: `global-search__collection global-search__collection--${category.id}`, textContent: category.label }));
