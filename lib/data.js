...
export function loadState() {
  ...
  return {
    ...
    maps: {
      cols: stored.maps && stored.maps.cols ? stored.maps.cols : null,
      hideNoMobs: stored.maps && typeof stored.maps.hideNoMobs === 'boolean' ? stored.maps.hideNoMobs : false,
    },
...
export function saveState(key, value) {
  try {
    ...
    } else if (key === 'maps' && value && value.cols) {
      current.maps = {
        cols: value.cols,
        hideNoMobs: typeof value.hideNoMobs === 'boolean' ? value.hideNoMobs : false,
      };
    } else if (key === 'showIds') {
