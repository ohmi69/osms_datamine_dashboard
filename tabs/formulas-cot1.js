...
export function renderFormulasCot1() {
  ...
  disclaimerText.append('This is a frozen snapshot of the formulas as they stood at the end of Closed Online Test 1. It is not updated - see the current Formulas tab for COT2 data.');
